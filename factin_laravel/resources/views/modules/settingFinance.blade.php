...
<ul class="col-2 text-center flex-justified">
    ...
    <a class="list-group-item-action list-group-item-success w-100 p-3 btn btn-success text-dark" href="#"><span class="icon-list-ul"></span> {{__('Liquidación Comisiones')}}</a>
    <div class="dropdown-divider form-divider"></div>
    <a class="list-group-item-action list-group-item-success w-100 p-3 btn btn-success text-dark" href="#"><span class="icon-line-chart"></span> {{__('Estadisticas Ventas')}}</a>
    <div class="dropdown-divider form-divider"></div>
