...
@section('info')
    <div>
		<div class="row border-bottom">
			<div class="col-md-4">
				<h6 class="navbar-brand">CREACION DE PRODUCTOS</h6>
			</div>
								...
								<div class="row justify-content-center">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" style="text-transform: uppercase" name="productname" maxlength="50" class="form-control form-control-sm" required>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="modal-dialog" style="font-size: 12px;"> <!-- modal-lg -->
			<div class="modal-content">
				<div class="modal-header">
					<h6>MODIFICACION DEL PRODUCTO</h6>
				</div>
				<div class="modal-body">
					<form action="{{route('product.update')}}" method="POST">
							...
							<div class="col-md-12 container-sm">
								<div class="row justify-content-center">
									<div class="col-md-8">
										<div class="form-group">
											<small class="text-muted">NOMBRE DEL PRODUCTO</small>
											<input type="text" style="text-transform: uppercase" name="productname_Edit" maxlength="50" class="form-control form-control-sm" required>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row border-top mt-3 text-center">
							<div class="col-md-6">
								<input type="hidden" class="form-control form-control-sm" name="productid_Edit" readonly required>
	...
	<div class="modal fade" id="deleteCreationPro-modal">
		<div class="modal-dialog" style="font-size: 12px;">
			<div class="modal-content">
				<div class="modal-header">
					<h6>ELIMINACION DE PRODUCTO:</h6>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12 text-center">
							<small class="text-muted">NOMBRE DEL PRODUCTO </small><br>
							<span class="text-muted"><b class="productname_Delete"></b></span><br>							
						</div>
					</div>
					<div class="row mt-3 border-top text-center">
						<form action="{{route('product.delete')}}" method="POST" class="col-md-6 DeleteSend">
							@csrf
							<input type="hidden" class="form-control form-control-sm" name="productid_Delete" readonly required>
...
@section('ScriptZone')
	<script>
		...
		$('.editCreation-link').on('click',function(e){				
			Swal.fire({
				...
				if (result.isConfirmed) {
                    ...
                    $('input[name=productname_Edit]').val(productname);
                    $('input[name=productid_Edit]').val(productid);
		...
		$('.deleteCreation-link').on('click',function(e){			
			...
			productid = $(this).find('span:nth-child(2)').text();
			productname = $(this).find('span:nth-child(3)').text();			
			$('input[name=productid_Delete]').val(productid);
			$('b.productname_Delete').text(productname);
